...
void MyTestFunction(void)
{
	...
	char nameC[100] = "Thereare  nospaceshereatall";
	RemoveSpaces(nameA);
	RemoveSpaces(nameB);
	RemoveSpaces(nameC);
	printf("   Name A = [%s]\n", nameA);
	...
	AddMoveToBoard(board7, size7, 'N', 8, 1, &rowPosition, &colPosition);
	printf("   Token position: row=%d, col=%d\n", rowPosition, colPosition);
	AddMoveToBoard(board7, size7, 'N', 3, 2, &rowPosition, &colPosition);
	printf("   Token position: row=%d, col=%d\n", rowPosition, colPosition);
	AddMoveToBoard(board7, size7, 'N', 8, 1, &rowPosition, &colPosition);
	printf("   Token position: row=%d, col=%d\n", rowPosition, colPosition);
	AddMoveToBoard (board7, size7, 'N', 2, 2, &rowPosition, &colPosition);
	AddMoveToBoard (board7, size7, 'N', 8, 1, &rowPosition, &colPosition);
	AddMoveToBoard (board7, size7, 'N', 1, 2, &rowPosition, &colPosition);
